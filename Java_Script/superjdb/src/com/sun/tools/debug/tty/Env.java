...
import com.sun.tools.debug.tty.EventRequestSpecList;
import com.sun.tools.debug.tty.MessageOutput;
//import com.sun.tools.debug.tty.SourceCode;
import com.sun.tools.debug.tty.SourceMapper;
...
public class Env {
    ...
    public static void init(String connectSpec, boolean openNow, int flags) throws IOException, IllegalConnectorArgumentsException {
