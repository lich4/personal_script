...
import com.sun.tools.debug.tty.AccessWatchpointSpec;
...
import com.sun.tools.debug.tty.ModificationWatchpointSpec;
import com.sun.tools.debug.tty.PatternReferenceTypeSpec;
import com.sun.tools.debug.tty.ReferenceTypeSpec;
...
class EventRequestSpecList {
	...
	public static void setStatus(int status) {
		EventRequestSpecList.status = status;
	}
}
